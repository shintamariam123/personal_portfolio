                ...
                <div className='row container-fluid '>
                    ...
                    <div className="col-xl-2  col-lg-12 d-flex flex-column align-items-center justify-content-start ">
                        ...
                        <button className='btn me-auto' style={{
                            ...
                            padding: '8px 15px',
                            borderRadius: '5px',
                            fontSize: '0.9rem', border: '2px solid rgb(120, 55, 10)'
                        }} ><a id='download' style={{ textDecoration: 'none', color: 'white', }} href="./src/resume/resume.pdf" download>DOWNLOAD CV</a></button>
                    </div>
                </div>
                <div>
